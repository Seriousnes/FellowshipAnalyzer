...
public sealed partial class SpiritTracker(ILogger<ResourceTracker> logger) : ResourceTracker(logger)
{
    ...
    /// <summary>Total Spirit gained by the player across the parse.</summary>
    ...
    /// <summary>The player's current Spirit.</summary>
    public int Current => Spirit?.Current ?? 0;
    /// <summary>The player's maximum Spirit.</summary>
