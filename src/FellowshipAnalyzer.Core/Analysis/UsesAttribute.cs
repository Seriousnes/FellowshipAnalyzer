...
/// resource-tracker class, <c>[Uses&lt;TDependency&gt;]</c> makes the source generator emit a
/// primary-constructor parameter <c>Lazy&lt;TDependency&gt;</c> and a cached read-only accessor
/// property named after <typeparamref name="TDependency"/> — e.g. <c>[Uses&lt;Haste&gt;]</c> yields
...
public sealed class UsesAttribute<TDependency> : Attribute
