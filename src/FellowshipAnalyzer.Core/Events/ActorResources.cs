...
public class ActorResources
{
    ...
    /// <summary>The actor's X coordinate on the fight map at the time of the event.</summary>
    public double X { get; set; }

    /// <summary>The actor's Y coordinate on the fight map at the time of the event.</summary>
