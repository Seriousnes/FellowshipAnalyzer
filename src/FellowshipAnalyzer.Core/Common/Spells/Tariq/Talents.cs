...
public class Talents
{
    ...
    public static Talent Concatenation { get; } = new Talent { Id = 73, Name = "Concatenation", Icon = "Berserker6.jpg" };
    ...
    public static Talent KillEmAll { get; } = new Talent { Id = 84, Name = "Kill 'Em All", Icon = "T_Ink_Hammerstorm.jpg" };
    public static Talent Thunderstruck { get; } = new Talent { Id = 89, Name = "Thunderstruck", Icon = "Electromancer1.jpg" };
    public static Talent Pneuma { get; } = new Talent { Id = 78, Name = "Pneuma", Icon = "T_Nhance_RPG_Energy_18.jpg" };
    public static Talent FarBeyondDriven { get; } = new Talent { Id = 79, Name = "Far Beyond Driven", Icon = "T_Nhance_RPG_Energy_13.jpg" };
    public static Talent MagicWard { get; } = new Talent { Id = 82, Name = "Magic Ward", Icon = "T_Arcane_Scroll.jpg" };
    ...
    public static Talent SquareHammer { get; } = new Talent { Id = 86, Name = "Square Hammer", Icon = "T_Ink_TimerAbility.jpg" };
    public static Talent SpitItOut { get; } = new Talent { Id = 88, Name = "Spit It Out", Icon = "T_Nhance_RPG_Icons_FieryHammer.jpg" };
    public static Talent SpiritedFortitude { get; } = new Talent { Id = 81, Name = "Spirited Fortitude", Icon = "Barbarian3.jpg" };
