...
{
    /// <summary>The full set of registered spells, keyed by <see cref="Spell.Guid"/>.</summary>
    public static IReadOnlyDictionary<int, Spell> All => Spells.All;

    /// <summary>
    /// Gets the spell with the given Guid.
    /// </summary>
    /// <exception cref="KeyNotFoundException">Thrown when no spell with the given Guid is registered.</exception>
    public static Spell Get(int id)
    {
        ...
        throw new KeyNotFoundException(
            $"Spell with Guid {id} is not registered. " +
    ...
    /// <summary>
    /// Gets the spell with the given Guid, or <see langword="null"/> if it is not registered.
    /// </summary>
