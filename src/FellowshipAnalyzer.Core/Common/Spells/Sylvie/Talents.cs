...
/// <summary>Sylvie's talent tree nodes as spell metadata (id, name, icon) for display; the source the generator reads to emit the <c>SylvieTalents</c> id constants.</summary>
public class Talents
{
    ...
    public static Talent SproutingNettles { get; } = new Talent { Id = 24, Name = "Sprouting Nettles", Icon = "Sylvie_AbilityIcon_02.jpg" };
    ...
    public static Talent Symbiosis { get; } = new Talent { Id = 21, Name = "Symbiosis", Icon = "T_Mosse_Vine.jpg" };
    /// <summary>The <c>Will of Nature</c> talent; its id backs the generated <c>SylvieTalents.WillOfNature</c> constant.</summary>
    public static Talent WillOfNature { get; } = new Talent { Id = 22, Name = "Will of Nature", Icon = "T_Icon_Fel_07.jpg" };
    ...
    /// <summary>The <c>Magic Ward</c> talent; its id backs the generated <c>SylvieTalents.MagicWard</c> constant.</summary>
    public static Talent MagicWard { get; } = new Talent { Id = 28, Name = "Magic Ward", Icon = "T_Arcane_Scroll.jpg" };
    ...
    /// <summary>The <c>Elusive Wildling</c> talent; its id backs the generated <c>SylvieTalents.ElusiveWildling</c> constant.</summary>
    public static Talent ElusiveWildling { get; } = new Talent { Id = 25, Name = "Elusive Wildling", Icon = "T_Mosse_Hide.jpg" };
    /// <summary>The <c>Spirited Fortitude</c> talent; its id backs the generated <c>SylvieTalents.SpiritedFortitude</c> constant.</summary>
    public static Talent SpiritedFortitude { get; } = new Talent { Id = 29, Name = "Spirited Fortitude", Icon = "Barbarian3.jpg" };
