...
/// <summary>Helena's talent tree nodes as spell metadata (id, name, icon) for display; the source the generator reads to emit the <c>HelenaTalents</c> id constants.</summary>
public class Talents
{
    ...
    /// <summary>The <c>Reinforced Steel</c> talent; its id backs the generated <c>HelenaTalents.ReinforcedSteel</c> constant.</summary>
    public static Talent ReinforcedSteel { get; } = new Talent { Id = 217, Name = "Reinforced Steel", Icon = "Tex_armor_3_b.jpg" };
    /// <summary>The <c>Guarded Veteran</c> talent; its id backs the generated <c>HelenaTalents.GuardedVeteran</c> constant.</summary>
    public static Talent GuardedVeteran { get; } = new Talent { Id = 211, Name = "Guarded Veteran", Icon = "T_Nhance_RPG_Fire_08_Yellow.jpg" };
    /// <summary>The <c>Punishing Strikes</c> talent; its id backs the generated <c>HelenaTalents.PunishingStrikes</c> constant.</summary>
    public static Talent PunishingStrikes { get; } = new Talent { Id = 212, Name = "Punishing Strikes", Icon = "T_Warmaster_FatalBlow.jpg" };
    ...
    /// <summary>The <c>Magic Ward</c> talent; its id backs the generated <c>HelenaTalents.MagicWard</c> constant.</summary>
    public static Talent MagicWard { get; } = new Talent { Id = 216, Name = "Magic Ward", Icon = "T_Arcane_Scroll.jpg" };
    ...
    public static Talent GleamingShield { get; } = new Talent { Id = 220, Name = "Gleaming Shield", Icon = "T_Nhance_RPG_Gold_05.jpg" };
    ...
    public static Talent FrontLineDefender { get; } = new Talent { Id = 221, Name = "Front Line Defender", Icon = "warmaster_shields_up.jpg" };
    /// <summary>The <c>Master of War</c> talent; its id backs the generated <c>HelenaTalents.MasterOfWar</c> constant.</summary>
    public static Talent MasterOfWar { get; } = new Talent { Id = 222, Name = "Master of War", Icon = "T_Nhance_RPG_Gold_03.jpg" };
    /// <summary>The <c>Greater Shockwave</c> talent; its id backs the generated <c>HelenaTalents.GreaterShockwave</c> constant.</summary>
    public static Talent GreaterShockwave { get; } = new Talent { Id = 223, Name = "Greater Shockwave", Icon = "T_Warmaster_shockwave.jpg" };
}
