...
public class Spells : ISpellRegistry
{
    ...
    public static Spell IceComet { get; } = new(1018, "Ice Comet", "T_Rime_OnTargetPulsatingAOE.jpg") { WinterOrbCost = 2 };
    ...
    public static Spell WrathOfWinter { get; } = new(1023, "Wrath of Winter", "T_Rime_SpiritAbility.jpg") { SpiritCost = 100 };
