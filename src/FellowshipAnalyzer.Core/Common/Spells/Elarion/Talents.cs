...
public static class Talents
{
    ...
    public static Talent PathOfTwilight { get; } = new Talent { Id = 131, Name = "Path of Twilight", Icon = "Bowguy_Abilityicon_Defensive.jpg" };
    public static Talent LunarlightAffinity { get; } = new Talent { Id = 203, Name = "Lunarlight Affinity", Icon = "T_Icon_Energy_108.jpg" };
    public static Talent MagicWard { get; } = new Talent { Id = 134, Name = "Magic Ward", Icon = "T_Arcane_Scroll.jpg" };
    ...
    public static Talent SpiritedFortitude { get; } = new Talent { Id = 135, Name = "Spirited Fortitude", Icon = "Barbarian3.jpg" };
    public static Talent TheWeightOfGravity { get; } = new Talent { Id = 165, Name = "The Weight of Gravity", Icon = "Bowguy_GrappleShot.jpg" };
}
