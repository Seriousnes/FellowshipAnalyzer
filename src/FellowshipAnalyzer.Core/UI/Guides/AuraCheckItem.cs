...
/// <summary>
/// One line of an <see cref="AuraChecklist"/>: an aura that either was or was not standing, optionally
/// carrying how much of it was standing.
/// </summary>
...
/// <param name="Pass">Whether the aura was standing.</param>
