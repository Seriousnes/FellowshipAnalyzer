...
public sealed partial class CombatLogParserTests
{
    ...
    {
        var owner = CreateCombatLogParser([typeof(CooldownReduction), typeof(SpellUsable), typeof(ProbeModule)]);
    ...
    {
        var owner = CreateCombatLogParser([typeof(CooldownReduction), typeof(SpellUsable), typeof(SpellFilterProbeModule)]);
