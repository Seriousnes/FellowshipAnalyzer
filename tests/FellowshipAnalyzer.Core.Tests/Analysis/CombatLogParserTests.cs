...
public sealed partial class CombatLogParserTests
{
    ...
    {
        var owner = CreateCombatLogParser([typeof(GemPowers), typeof(CooldownReduction), typeof(SpellUsable), typeof(ProbeModule)]);
    ...
    {
        var owner = CreateCombatLogParser([typeof(GemPowers), typeof(CooldownReduction), typeof(SpellUsable), typeof(SpellFilterProbeModule)]);
