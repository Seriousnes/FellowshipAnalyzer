...
public sealed class BurstWindowAnalyzerTests
{
    ...
    public async Task Analyze_TrashPull_IsAlsoEvaluated()
    {
        ...
        parser.BurstWindowAnalyzers.ShouldHaveSingleItem()
    ...
    public async Task Analyze_DungeonRun_ScoresEachPullAgainstItsOwnLength()
    {
        ...
        var entries = parser.BurstWindowAnalyzers;
    ...
    public async Task Analyze_RetainsTheAnalyzerOnEveryPullReadPath()
    {
        ...
        var entry = parser.BurstWindowAnalyzers.ShouldHaveSingleItem();
        var pull = entry.Pull;

        pull.BurstWindowAnalyzer.ShouldBeSameAs(entry.Analyzer);
        parser.For(pull).BurstWindowAnalyzer.ShouldBeSameAs(entry.Analyzer);
    }
