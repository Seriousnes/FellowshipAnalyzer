...
public sealed class WintersEmbraceAnalyzerTests
{
    ...
    public async Task SingleTargetWindowOpenedOnTheSpender_ScoresSuccessful()
    {
        ...
        var window = analyzer.Windows.ShouldHaveSingleItem()
            .ShouldBeOfType<SingleTargetEmbraceAnalyzer.SingleTargetWindowEvaluation>();
    ...
    public async Task AoeWindowWithTwoSpendersAndColdSnap_ScoresSuccessful()
    {
        ...
        var window = analyzer.Windows.ShouldHaveSingleItem()
            .ShouldBeOfType<AoeEmbraceAnalyzer.AoeWindowEvaluation>();
    ...
    public async Task PerPullReadPathsResolveToTheSameAnalyzerInstance()
    {
        ...
        var entry = parser.WintersEmbraceAnalyzers.ShouldHaveSingleItem();
        entry.Analyzer.ShouldBeOfType<SingleTargetEmbraceAnalyzer>();
        entry.Pull.WintersEmbraceAnalyzer.ShouldBeSameAs(entry.Analyzer);
        parser.For(entry.Pull).WintersEmbraceAnalyzer.ShouldBeSameAs(entry.Analyzer);
    }
